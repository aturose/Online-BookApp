...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory> implements Filterable {
    ...
    public HolderCategory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //bind or inflate row_category.xml
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        ...
        holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Delete")
                        .setMessage("Sure you want to delete this book category?")
                        .setPositiveButton("Please confirm", new DialogInterface.OnClickListener() {
                            @Override
                        ...
                        .setNegativeButton("Cancel here", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                            }
        ...
        //handle item click, goto PdfListAdminActivity, also pass pdf category and categotyId
